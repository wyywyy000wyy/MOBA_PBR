...
#region Unity Interface
	...
	{
        GameObject spawnedGameObjects = GameObject.Find("Spawned_GameObjects");
		...
		for (int i = spawnedGameObjects.transform.childCount - 1; i >= 0; i--)
		{
			parent = spawnedGameObjects.transform.GetChild(i);
