...
namespace XLua.CSObjectWrap
{
    ...
    public class XLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "GetCache", _m_GetCache_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "PushCache", _m_PushCache_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "LoadAsync", _m_LoadAsync_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "LoadBundleAsync", _m_LoadBundleAsync_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetCache_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.Type _t = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Object gen_ret = XLoader.GetCache( _path, _t );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_PushCache_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                    System.Type _t = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                    UnityEngine.Object _o = (UnityEngine.Object)translator.GetObject(L, 3, typeof(UnityEngine.Object));
                    
                    XLoader.PushCache( _path, _t, _o );
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Action<UnityEngine.Object> _callback = translator.GetDelegate<System.Action<UnityEngine.Object>>(L, 3);
                        ...
                        UnityEngine.Coroutine gen_ret = XLoader.LoadAsync( _path, _type, _callback );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LoadBundleAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.Action<UnityEngine.Object> _callback = translator.GetDelegate<System.Action<UnityEngine.Object>>(L, 2);
                        ...
                        UnityEngine.Coroutine gen_ret = XLoader.LoadBundleAsync( _name, _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string[] _paths = (string[])translator.GetObject(L, 1, typeof(string[]));
                        ...
                        UnityEngine.Object[] gen_ret = XLoader.LoadMulti( _paths );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Action<UnityEngine.Object[]> _callback = translator.GetDelegate<System.Action<UnityEngine.Object[]>>(L, 2);
                        ...
                        UnityEngine.Coroutine gen_ret = XLoader.LoadMultiAsync( _paths, _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Action<bool> _callback = translator.GetDelegate<System.Action<bool>>(L, 2);
                        ...
                        UnityEngine.Coroutine gen_ret = XLoader.LoadSceneAsync( _name, _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Object gen_ret = XLoader.Load( _path, _type );
                        translator.Push(L, gen_ret);
        ...
        static int _m_UnloadUnusedAssets_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.AsyncOperation gen_ret = XLoader.UnloadUnusedAssets(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Initialize_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    bool _useExternalFolder = LuaAPI.lua_toboolean(L, 1);
                    
                    XLoader.Initialize( _useExternalFolder );
