...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp6(int p0, UnityEngine.Vector3 p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(bool p0, UnityEngine.Texture2D p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(int p0, UnityEngine.Transform p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(UnityEngine.Vector2 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<int, UnityEngine.Vector3>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(System.Action<bool, UnityEngine.Texture2D>))
			{
			    return new System.Action<bool, UnityEngine.Texture2D>(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(System.Action<int, UnityEngine.Transform>))
			{
			    return new System.Action<int, UnityEngine.Transform>(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(System.Action<int, int>))
			{
			    return new System.Action<int, int>(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.Vector2>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.Vector2>(__Gen_Delegate_Imp10);
			}
